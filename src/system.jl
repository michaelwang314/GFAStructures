...
initialize_lattice(unit_cell::Vector{Subunit}, lattice_vectors::NTuple{2, Vector{Float64}}, lattice_dimensions::NTuple{2, Int64}) = initialize_lattice(unit_cell, (lattice_vectors[1], lattice_dimensions[2], [0.0, 0.0, 1.0]), (lattice_dimensions[1], lattice_dimensions[2], 1))
